...
$(LINUX_REPO_PATH):
	...
	git clone --depth 1 -b fdi-nh5-linux-5.10.167 https://github.com/DASICS-ICT/riscv-linux.git $@
	$(RFS_ENV) $(MAKE) -C $@ ARCH=riscv emu_defconfig

$(ROOTFS_PATH):
	mkdir -p $@
	git clone -b fdi-nh5 https://github.com/DASICS-ICT//riscv-rootfs.git $@
