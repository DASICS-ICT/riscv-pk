...
#define CAUSE_DASICS_UFETCH_ACCESS 0x10
#define CAUSE_DASICS_SFETCH_ACCESS 0X11
#define CAUSE_DASICS_ULOAD_ACCESS 0x12
#define CAUSE_DASICS_SLOAD_ACCESS 0x13
#define CAUSE_DASICS_USTORE_ACCESS 0x14
#define CAUSE_DASICS_SSTORE_ACCESS 0x15
#endif
#ifdef DECLARE_INSN
...
DECLARE_CAUSE("dasics user fetch access", CAUSE_DASICS_UFETCH_ACCESS)
DECLARE_CAUSE("dasics supervisor fetch access", CAUSE_DASICS_SFETCH_ACCESS)
DECLARE_CAUSE("dasics user load access", CAUSE_DASICS_ULOAD_ACCESS)
DECLARE_CAUSE("dasics supervisor load access", CAUSE_DASICS_SLOAD_ACCESS)
DECLARE_CAUSE("dasics user store access", CAUSE_DASICS_USTORE_ACCESS)
DECLARE_CAUSE("dasics supervisor store access", CAUSE_DASICS_SSTORE_ACCESS)
#endif
