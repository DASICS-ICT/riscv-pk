...
#define CAUSE_DASICS_MODEU_FETCH_ACCESS 0x10
#define CAUSE_DASICS_MODES_FETCH_ACCESS 0X11
#define CAUSE_DASICS_MODEU_LOAD_ACCESS 0x12
#define CAUSE_DASICS_MODES_LOAD_ACCESS 0x13
#define CAUSE_DASICS_MODEU_STORE_ACCESS 0x14
#define CAUSE_DASICS_MODES_STORE_ACCESS 0x15
#endif
#ifdef DECLARE_INSN
...
DECLARE_CAUSE("dasics user fetch access", CAUSE_DASICS_MODEU_FETCH_ACCESS)
DECLARE_CAUSE("dasics supervisor fetch access", CAUSE_DASICS_MODES_FETCH_ACCESS)
DECLARE_CAUSE("dasics user load access", CAUSE_DASICS_MODEU_LOAD_ACCESS)
DECLARE_CAUSE("dasics supervisor load access", CAUSE_DASICS_MODES_LOAD_ACCESS)
DECLARE_CAUSE("dasics user store access", CAUSE_DASICS_MODEU_STORE_ACCESS)
DECLARE_CAUSE("dasics supervisor store access", CAUSE_DASICS_MODES_STORE_ACCESS)
#endif
